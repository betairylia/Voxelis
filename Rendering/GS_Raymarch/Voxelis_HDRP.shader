Shader "VoxelisHDRP/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Voxelis_HDRPOverrides/ShaderPassDepthOnly.hlsl"
        ...
        Pass
        {
            ...
            #include "Voxelis_HDRPOverrides/ShaderPassGBuffer.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitData.hlsl"
            #include "Voxelis_HDRPOverrides/ShaderPassLightTransport.hlsl"
        ...
        Pass
        {
            ...
            #endif
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitData.hlsl"
            #include "Voxelis_HDRPOverrides/ShaderPassMotionVectors.hlsl"
